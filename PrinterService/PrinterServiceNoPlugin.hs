...
client 0 self other = do writeChan other (toDyn "done")
...
client count self other =
     do writeChan other (toDyn ("ping", self))
        ...
        case msg of
          Is "pong" -> do
            putStrLn "printing!"
            writeChan other (toDyn ("print", (toDyn (count, count))))
            writeChan other (toDyn ("print", (toDyn "thanks")))
  ...
  do msg <- readChan self
     case msg of
      ...
      Is ("print", toPrint :: Dynamic) -> do
        ...
        putStrLn $ case toPrint of
                    Is (tp :: (Int, Int)) -> printIt tp
                    Is (tp :: String) -> printIt tp
